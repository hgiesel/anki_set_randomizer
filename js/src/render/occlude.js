  ...
  if (pa.getProp(['display']) === 'none') {
    ...
    switch (shapeName) {
      ...
      case 'line': case 'arrow': case 'darrow':
        ...
        defs.children[0].setAttribute('markerWidth', 15 * scalingFactorX)
        defs.children[0].setAttribute('markerHeight', 10 * scalingFactorY)
        defs.children[0].setAttribute('refX', 1.5 * scalingFactorX)
        defs.children[0].setAttribute('refY', 2 * scalingFactorY)
