...
class Ui_SROptionTab(object):
    ...
    def retranslateUi(self, SROptionTab):
        ...
        self.cssColorsLabel.setToolTip(_translate("SROptionTab", "<html><head/><body><p>A list of CSS colors. The first field will be displayed with the first color. Colors will be repeated, if fields exceed colors.</p></body></html>"))
        ...
        self.cssColorsCollectiveIndexingCheckBox.setToolTip(_translate("SROptionTab", "Normally, the choice of color is reset for each new randomized set. With this option, all elements collectively will iterate through the colors. E.g. Two sets with one element each will both have color 1, with this option turned on, the second one will have color 2."))
        self.cssColorsCollectiveIndexingCheckBox.setText(_translate("SROptionTab", "Collective Color Indexing"))
        self.cssColorsRandomStartIndexCheckBox.setToolTip(_translate("SROptionTab", "Normally, the choice of color always start with color 1. With this option turned on, the first color will be chosen at random, before normally iterating through the colors again."))
        ...
        self.htmlClassesRandomStartIndexCheckBox.setToolTip(_translate("SROptionTab", "Normally, the choice of color always start with color 1. With this option turned on, the first color will be chosen at random, before normally iterating through the colors again."))
        self.htmlClassesRandomStartIndexCheckBox.setText(_translate("SROptionTab", "Random Start Class Index"))
        self.htmlClassesCollectiveIndexingCheckBox.setToolTip(_translate("SROptionTab", "Normally, the choice of color is reset for each new randomized set. With this option, all elements collectively will iterate through the colors. E.g. Two sets with one element each will both have color 1, with this option turned on, the second one will have color 2."))
        ...
        self.htmlClassesLabel.setToolTip(_translate("SROptionTab", "<html><head/><body><p>A list of CSS colors. The first field will be displayed with the first color. Colors will be repeated, if fields exceed colors.</p></body></html>"))
        ...
        self.cssSelectorLabel.setToolTip(_translate("SROptionTab", "<html><head/><body><p>A CSS query to select the elements which contain all Multiple Choices.</p></body></html>"))
        ...
        self.isRegexCheckBox.setToolTip(_translate("SROptionTab", "Check if you want to generate the div tags for the card. Check if this if you have no idea how to edit card templates."))
