...
class Ui_SRIterationConfig(object):
    def setupUi(self, SRIterationConfig):
        ...
        SRIterationConfig.resize(794, 486)
        ...
        self.gridLayout_5 = QtWidgets.QGridLayout(self.generalOptions)
        ...
        self.gridLayout_5.addWidget(self.descriptionTextEdit, 3, 0, 1, 3)
        self.importButton = QtWidgets.QPushButton(self.generalOptions)
        self.importButton.setObjectName("importButton")
        self.gridLayout_5.addWidget(self.importButton, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.enableIterationCheckBox, 0, 1, 1, 1)
    ...
    def retranslateUi(self, SRIterationConfig):
        ...
        self.importButton.setText(_translate("SRIterationConfig", "⎈ Import / Export"))
