...
class Ui_SRInjectionConfig(object):
    def setupUi(self, SRInjectionConfig):
        ...
        SRInjectionConfig.resize(794, 512)
        ...
        self.gridLayout.addWidget(self.descriptionTextEdit, 3, 0, 1, 6)
        self.importButton = QtWidgets.QPushButton(self.generalOptions)
        ...
        self.gridLayout.addWidget(self.nameLineEdit, 2, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.enableInjectionCheckBox, 1, 3, 1, 2)
        ...
        self.gridLayout_2.addItem(spacerItem2, 2, 0, 1, 5)
    ...
    def retranslateUi(self, SRInjectionConfig):
        ...
        self.importButton.setText(_translate("SRInjectionConfig", "⎈ Import / Export"))
        ...
        self.enableInjectionCheckBox.setText(_translate("SRInjectionConfig", "Enable this injection"))
